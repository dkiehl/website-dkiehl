...
<%
	...
	RS.open sql,CN,3,3
	RS.addnew
	RS.fields("TStamp") = Now
	RS.fields("UserID") = IPUser
	RS.fields("IPAddr") = ip
	RS.update
	RS.close
	CN.close

	If IPUser = "" then Response.Redirect "http://www.itad365bc.com/default.html"
	If IPUser = "NO" then Response.Redirect "http://www.itad365bc.com/default.html"
